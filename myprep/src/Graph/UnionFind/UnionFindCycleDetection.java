...
public class UnionFindCycleDetection 
{
	...
	// Finding cycle in graph using Union Find Algorithm
	// 1. Find 2. Union
	// Explanation : https://www.youtube.com/watch?v=wU6udHRIkcc
	...
	{ 
		...
		UnionFindCycleDetection obj = new UnionFindCycleDetection();

		if (obj.isCycle(graph) == 1)
		{
