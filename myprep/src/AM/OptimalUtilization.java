...
/*
	...
	Return a list of id's of selected elements. If no pair is possible, return an empty list.
...
{
	 private List<List<Integer>> getPairs( int[][] a, int[][] b, int target ) 
	 {
	 ...
	 // if we sort two arrays , we can improve time complexity slightly 
